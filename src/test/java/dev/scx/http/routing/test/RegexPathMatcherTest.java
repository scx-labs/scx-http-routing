...
public class RegexPathMatcherTest {
    ...
    public static void test1() {
        ...
        PathMatch match = pathMatcher.match("/users/123/books/456");
    ...
    public static void test2() {
        ...
        PathMatch match = pathMatcher.match("/users/42/books/99");
    ...
    public static void test3() {
        ...
        PathMatch match = pathMatcher.match("/en/users/123/posts/456");
    ...
    public static void test5() {
        PathMatcher pathMatcher =
            PathMatcher.ofRegex("/users/(?<id>\\d+)(?:/posts/(?<postId>\\d+))?");
        PathMatch match = pathMatcher.match("/users/123/posts/456");
